...
//    320/184
    ...
    if ([CPGlobalDataManager shareGlobalData].isReviewVersion) {
        ...
        _modelList = @[
//                       [CPMineActionModel modelName:@"我的推荐[推荐好友获取收益]" icon:@"shezhi_04_goucai_mine" identify:1],
//                       [CPMineActionModel modelName:@"系统公告" icon:@"geren_tubiao_06_goucai_mine" identify:2],
                       [CPMineActionModel modelName:@"投注记录" icon:@"geren_tubiao_13_goucai_mine" identify:1],
                       [CPMineActionModel modelName:@"中奖记录" icon:@"geren_tubiao_24_goucai_mine" identify:2],
//                       [CPMineActionModel modelName:@"账户明细" icon:@"geren_tubiao_26_goucai_mine" identify:3],
...
//                       [CPMineActionModel modelName:@"我的红包" icon:@"geren_tubiao_hb_goucai_mine" identify:10],
                       [CPMineActionModel modelName:@"个人消息" icon:@"geren_tubiao_06_goucai_mine" identify:3]
                       ];
